...
//only  than>= 8
db.books.find({rating:{$get:8}}).pretty();
//less than <8
...
//name and rating only
db.books.find({},{ name:1,  rating:1}).pretty();
//name and rating cancel
db.books.find({},{ name:0,  rating:0}).pretty();
//sorting
//ascending =1
//dis ascending =-1=0

//ascending rating  or any value ascending adders line quit
...
//frist 2 books with highest  rating
